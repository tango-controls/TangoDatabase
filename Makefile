#PROTECTED REGION ID(DataBase::Makefile) ENABLED START#
#=============================================================================
#
# file :        Makefile
#
...
INC_DIR_USER= -I .   -I $(MYSQL_INC_DIR)
...
MYSQL_LIB_DIR=/usr/lib$(MyNbBits)/mysql
LIB_DIR_USER= -L $(MYSQL_LIB_DIR) -lmysqlclient_r
...
POST_PROCESSING = \
	mv bin/$(BIN_DIR)/$(PACKAGE_NAME) bin/$(BIN_DIR)/$(PACKAGE_NAME)ds
...
ADDITIONAL_OBJS =  \
	$(OBJDIR)/DataBaseUtils.o \
	$(OBJDIR)/update_starter.o
